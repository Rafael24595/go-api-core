...
const (
	CSVT_HISTORIC_FILE_PATH string = "./db/collection_response_historic.csvt"
	CSVT_PERSISTED_FILE_PATH string = "./db/collection_response_persisted.csvt"
)
...
func (m *ManagerCsvtFile) Read() (map[string]domain.Response, error) {
	...
	requests := map[string]domain.Response{}
...
func (m *ManagerCsvtFile) Write(responses []any) error {
